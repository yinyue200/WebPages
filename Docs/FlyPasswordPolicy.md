...
* we collect it automatically through our products and services (e.g., when your checks with us to see if is up to date);
* someone else tells us information about you (e.g., when the software works with your email providers to set up your account); or
...
The license is based on a Mozilla's Privacy Policy.
